...
## How to use
Simply install by running `yarn install react-native-dynamic-tab-view-ard`

Use it by 

```
import DynamicTabView from 'react-native-dynamic-tab-view-ard';
 <DynamicTabView
        data={dataSource}
        renderTab={renderTab}
...
### Contributors 
* [@halimatak](https://github.com/halimatak)